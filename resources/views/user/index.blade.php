                    ...
                    <div class="tab-content" id="myTabContent">
                            ...
                            <div class="dashboard-right">
                                <div class="dashboard">
                                    ...
                                    <div class="welcome-msg">
                                        <h6 class="font-light">Hello, <span style="text-transform: uppercase;">{{ $user->name }} !</span></h6>
                                ...
                                <table class="table cart-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="details.php">
                                                    <img src="/productimage/{{ $order->image }}" class="blur-up lazyload" alt="">
                                                </a>
                                            </td>
                                            <td>
                                                <p class="mt-0">5563853658932{{ $order->id }}</p>
                                            </td>
                                            <td>
                                                <p class="fs-6 m-0">{{ $order->product_title }}</p>
                                            </td>
                                            <td>
                                                <p class="success-button btn btn-sm">{{ $order->delivery_status }}</p>
                                            </td>
                                            <td>
                                                <p class="theme-color fs-6">₱{{ $order->price }}.00</p>
                                            </td>
                                            <td>
                                ...
                                <table class="table cart-table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <a href="details.php">
                                                    <img src="/productimage/{{ $wishlist->image }}" alt="">
                                                </a>
                                            </td>
                                            <td>
                                                <p class="m-0">5563853658932{{ $wishlist->id }}</p>
                                            </td>
                                            <td>
                                                <p class="theme-color fs-6">${{ $wishlist->price }}</p>
                                            </td>
                                            <td>
                                                <a type="submit" class="btn btn-solid-default btn-sm fw-bold">
                                                    Move to Cart
                                                </a>
                                            </td>
                                        </tr>
                        ...
                        <div class="tab-pane fade dashboard-security dashboard" id="security">
                            ...
                            <div class="security-details">
                                <h5 class="font-light mt-3">Hi <span> {{ $user->name }},</span>
                                </h5>
