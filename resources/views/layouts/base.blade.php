                    ...
                    <div class="col-lg-12">
                        <div class="main-menu">
                                ...
                                <div class="main-navbar">
                                    <div id="mainnav">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li><a href="{{ url('/shop') }}" class="nav-link menu-title">Shop</a></li>
                                            <li><a href="{{ url('/show_cart') }}" class="nav-link menu-title">Cart</a></li>
                                            <li><a href="{{ url('/about_us') }}" class="nav-link menu-title">About Us</a></li>
                                            <li><a href="{{ url('/contact_us') }}" class="nav-link menu-title">Contact Us</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                                    ...
                                    <li class="onhover-dropdown wislist-dropdown">
                                        <div class="cart-media">
                                            <a href="{{ url('/show_wishlist') }}">
                                                ...
                                                <span id="wishlist-count" class="label label-theme rounded-pill">{{ $counts }}</span>
                                            </a>
                                        </div>
                                    </li>
                                    <li class="onhover-dropdown wislist-dropdown">
                                        <div class="cart-media">
                                            <a href="{{ url('show_cart') }}">
                                                ...
                                                <span id="cart-count" class="label label-theme rounded-pill">{{ $count }}</span>
                                            </a>
                                        </div>
                                    </li>
                            ...
                            <div class="search-full">
                                <form class="search-full" action="{{ url('search') }}" method="GET">
                                    @csrf
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-contact">
                            ...
                            <ul class="contact-lists" style="clear:both;">
                                <li>
                                    <span><b>phone:</b> <span class="font-light"> +639-12-548-7561</span></span>
                                </li>
                                <li>
                                    <span><b>Address:</b><span class="font-light">Japanacan, Davao City, Philippines</span></span>
                                </li>
                                <li>
                                    <span><b>Email:</b><span class="font-light"> meljamescortes@gmail.com</span></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-2 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{ url('/') }}" class="font-dark">Home</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/shop') }}" class="font-dark">Shop</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/about_us') }}" class="font-dark">About Us</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/contact_us') }}" class="font-dark">Contact</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="shop.html" class="font-dark">Nike Shoes</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Puma Shoes</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Adidas Shoes</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Under Armor Shoes</a>
                                    </li>
                                    <li>
                                        <a href="shop.html" class="font-dark">Spartan</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-2 col-lg-3 col-md-4 col-sm-6">
                        <div class="footer-links">
                            ...
                            <div class="footer-content">
                                <ul>
                                    <li>
                                        <a href="{{ url('/my-account') }}" class="font-dark">Your Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/my-account') }}" class="font-dark">Your Account</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/my-account') }}" class="font-dark">Track Orders</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/wishlist') }}" class="font-dark">Your Wishlist</a>
                                    </li>
                                    <li>
        ...
        <div class="sub-footer">
            <div class="container">
                <div class="row gy-3">
                    ...
                    <div class="col-md-6">
                        <p class="mb-0 font-dark">© 2024, Asentrix.</p>
                    </div>
                </div>
            </div>
        </div>
