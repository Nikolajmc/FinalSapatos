                    ...
                    <div class="row g-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div class="details-image-1 ratio_asos">
                                        <div>
                                            <a href="">
                                                <img src="/productimage/{{ $product->image }}" id="zoom_01"
                        ...
                        <div class="col-md-6">
                            <div class="cloth-details-size">
                                ...
                                <h3 class="price-detail">₱{{ $product->price }}.00 <span>{{ $product->discount_price }}% off</span></h3>
                                ...
                                <div class="product-buttons" style="gap: 10px;">
                                        <a type="submit"  id="cartEffect" class="btn btn-solid hover-solid btn-animation">
                                            <i class="fa fa-shopping-cart"></i>
                                            <span>Add to Cart<input style="opacity: 0; border: none; color: white; position:absolute; top: 0; left: 0px; padding-bottom: 30px; padding-right: 110px;"  type="submit" value="Add to Cart"></span>
                                        </a>
                                    </form>
                                    
                                    <form action="{{ url('add_wishlist', $product->id)   }}" method="POST">
                                        @csrf
                                        <a type="submit" class="btn btn-solid hover-solid btn-animation">
                                            <i class="fa fa-bookmark fz-16 me-2"></i>
                                            <span>Add Wishlist<input style="opacity: 0; border: none; color: white; position:absolute; top: 0; left: 0px; padding-bottom: 30px; padding-right: 120px;"  type="submit" value="Shout Out"></span>
                                        </a>
                                    </form>
                                </div>
                                ...
                                <div class="mt-2 mt-md-3 border-product">
                                    <h6 class="product-title hurry-title d-block">Hurry Up! Left <span>{{ $product->quantity }}</span> in
                                        stock</h6>
                                    {{-- <div class="progress">
                ...
                <div class="cloth-review">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                            ...
                            <button class="nav-link active" id="nav-speci-tab" data-bs-toggle="tab" data-bs-target="#speci"
